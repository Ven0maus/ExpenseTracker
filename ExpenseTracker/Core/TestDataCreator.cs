namespace ExpenseTracker.Core
{
    internal class TestDataCreator
    {
        ...
        public const int DebugDataSeed = 1337;
        ...
        {
            { "Groceries", new CategoryInfo { Weight = 40, Shops = ["Aldi", "Frituur", "Carrefour", "Delhaize", "Colruyt", "Lidl"], MinPrice = 10, MaxPrice = 100 } },
            { "Clothes & Goods", new CategoryInfo { Weight = 30, Shops = ["Action", "Zeeman", "Primark", "Hema", "Wibra"], MinPrice = 15, MaxPrice = 120 } },
            { "Entertainment", new CategoryInfo { Weight = 15, Shops = ["Cinema", "Cafe", "Dinner"], MinPrice = 10, MaxPrice = 60 } },
            { "Subscriptions", new CategoryInfo { Weight = 10, Shops = ["Internet", "Electrabel", "Pidpa", "Spotify", "Netflix"], MinPrice = 20, MaxPrice = 70 } },
            { "Others", new CategoryInfo { Weight = 5, Shops = ["IKEA", "Kraker", "MegaMeubel", "Krefel", "Hubo"], MinPrice = 30, MaxPrice = 300 } }
        };
